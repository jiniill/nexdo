  ...
  return (
    <>
      ...
      >
        ...
        <span className="flex-1 text-slate-400">Search</span>
      ...
      <Modal
        ...
        containerClassName="pt-[15vh]"
        contentClassName="w-full max-w-xl bg-white rounded-xl shadow-2xl border border-slate-200 overflow-hidden animate-in fade-in zoom-in-95 duration-200"
      >
        {/* Search Input */}
